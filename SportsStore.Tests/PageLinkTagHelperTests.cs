...
namespace SportsStore.Tests
{
    public class PageLinkTagHelperTests
    {
        ...
        {
            // Arrange
            var urlHelper = new Mock<IUrlHelper>(); urlHelper.SetupSequence(x =>
            ...
            var content = new Mock<TagHelperContent>(); TagHelperOutput output = new TagHelperOutput("div",
            ...
            + @"<a href=""Test/Page2"">2</a>" + @"<a href=""Test/Page3"">3</a>",
